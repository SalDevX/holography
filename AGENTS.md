...
# Specialized agent team for python · 74 nodes.
...
- Never modify god nodes without declaring in task description: `_buildContext()` (npm/cli.js, 15 edges), `_runUpdate()` (npm/cli.js, 9 edges), `MetaController` (tools/meta_controller.py, 5 edges), `files_in_diff()` (tools/validator.py, 5 edges)
...
Graph source: `graphify-out/GRAPH_REPORT.md` · 74 nodes · 108 edges · last run 2026-05-24

| Node | Edges | File | Owner | Notes |
|------|-------|------|-------|-------|
| `_buildContext()` | 15 | `npm/cli.js` | — | |
| `_runUpdate()` | 9 | `npm/cli.js` | — | new in 57480af |
| `files_in_diff()` | 5 | `tools/validator.py` | — | |
| `_rule_sftp_deploy_logic_gate()` | 5 | `tools/validator.py` | — | |
| `_rule_mobile_desktop_parity()` | 5 | `tools/validator.py` | — | uses files_touched_in_diff() since 0d3e0ad |
| `MetaController` | 5 | `tools/meta_controller.py` | — | |
| `_groupByDir()` | 5 | `npm/cli.js` | — | |
| `_rule_no_direct_data_js_edit()` | 4 | `tools/validator.py` | — | |
| `_rule_asset_path_consistency()` | 4 | `tools/validator.py` | — | |
| `_load_project_rules()` | 4 | `tools/validator.py` | — | |
